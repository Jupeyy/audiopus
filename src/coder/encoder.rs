...
impl GenericCtl for Encoder {
    ...
    fn final_range(&self) -> Result<u32> {
        self.encoder_ctl_request(ffi::OPUS_GET_FINAL_RANGE_REQUEST as i32)
            .map(|v| v as u32)
    }

    /// Gets the encoder's configured phase inversion status.
    fn phase_inversion_disabled(&self) -> Result<bool> {
        self.encoder_ctl_request(ffi::OPUS_SET_PHASE_INVERSION_DISABLED_REQUEST as i32)
            .map(|b| b == 1)
    }
    ...
    fn set_phase_inversion_disabled(&mut self, disabled: bool) -> Result<()> {
        ...
        self.set_encoder_ctl_request(
            ffi::OPUS_SET_PHASE_INVERSION_DISABLED_REQUEST as i32,
    ...
    fn sample_rate(&self) -> Result<SampleRate> {
        self.encoder_ctl_request(ffi::OPUS_GET_SAMPLE_RATE_REQUEST as i32)
    ...
    fn reset_state(&mut self) -> Result<()> {
        self.encoder_ctl_request(ffi::OPUS_RESET_STATE as i32)
            .map(|_| ())
    }
}
...
impl Encoder {
    ...
    pub fn new(sample_rate: SampleRate, channels: Channels, mode: Application) -> Result<Encoder> {
        ...
        if opus_code == ffi::OPUS_OK as i32 || !pointer.is_null() {
    ...
    pub fn complexity(&self) -> Result<u8> {
        self.encoder_ctl_request(ffi::OPUS_GET_COMPLEXITY_REQUEST as i32)
            .map(|v| v as u8)
    }
    ...
    pub fn set_complexity(&mut self, complexity: u8) -> Result<()> {
        self.set_encoder_ctl_request(
            ffi::OPUS_SET_COMPLEXITY_REQUEST as i32,
            i32::from(complexity),
        )
    }
    ...
    pub fn application(&self) -> Result<Application> {
        self.encoder_ctl_request(ffi::OPUS_GET_APPLICATION_REQUEST as i32)
    ...
    pub fn set_application(&mut self, application: Application) -> Result<()> {
        self.set_encoder_ctl_request(ffi::OPUS_SET_APPLICATION_REQUEST as i32, application as i32)
            .map(|_| ())
    }
    ...
    pub fn set_bitrate(&mut self, bitrate: Bitrate) -> Result<()> {
        self.set_encoder_ctl_request(ffi::OPUS_SET_BITRATE_REQUEST as i32, bitrate.into())?;
    ...
    pub fn bitrate(&self) -> Result<Bitrate> {
        self.encoder_ctl_request(ffi::OPUS_GET_BITRATE_REQUEST as i32)
    ...
    pub fn set_vbr_constraint(&mut self, enable: bool) -> Result<()> {
        ...
        self.set_encoder_ctl_request(
            ffi::OPUS_SET_VBR_CONSTRAINT_REQUEST as i32,
    ...
    pub fn vbr_constraint(&self) -> Result<bool> {
        self.encoder_ctl_request(ffi::OPUS_GET_VBR_CONSTRAINT_REQUEST as i32)
            .map(|b| b == 1)
    }
    ...
    pub fn set_vbr(&mut self, enable: bool) -> Result<()> {
        ...
        self.set_encoder_ctl_request(ffi::OPUS_SET_VBR_REQUEST as i32, if_vbr_shall_be_enabled)
            .map(|_| ())
    }

    /// Determine if variable bitrate (VBR) is enabled in the encoder.
    pub fn vbr(&self) -> Result<bool> {
        self.encoder_ctl_request(ffi::OPUS_GET_VBR_REQUEST as i32)
            .map(|b| b == 1)
    }
    ...
    pub fn set_inband_fec(&mut self, enable: bool) -> Result<()> {
        ...
        self.set_encoder_ctl_request(
            ffi::OPUS_SET_INBAND_FEC_REQUEST as i32,
    ...
    pub fn inband_fec(&self) -> Result<bool> {
        self.encoder_ctl_request(ffi::OPUS_GET_INBAND_FEC_REQUEST as i32)
            .map(|n| n == 1)
    }

    /// Gets the encoder's configured packet loss percentage.
    pub fn packet_loss_perc(&self) -> Result<u8> {
        self.encoder_ctl_request(ffi::OPUS_GET_PACKET_LOSS_PERC_REQUEST as i32)
            .map(|n| n as u8)
    }
    ...
    pub fn set_packet_loss_perc(&mut self, percentage: u8) -> Result<()> {
        self.set_encoder_ctl_request(
            ffi::OPUS_SET_PACKET_LOSS_PERC_REQUEST as i32,
            i32::from(percentage),
        )
        .map(|_| ())
    }
    ...
    pub fn lookahead(&self) -> Result<u32> {
        self.encoder_ctl_request(ffi::OPUS_GET_LOOKAHEAD_REQUEST as i32)
            .map(|n| n as u32)
    }
    ...
    pub fn set_force_channels(&mut self, channels: Channels) -> Result<()> {
        self.set_encoder_ctl_request(ffi::OPUS_SET_FORCE_CHANNELS_REQUEST as i32, channels as i32)
            .map(|_| ())
    }

    /// Gets the encoder's forced channel configuration.
    pub fn force_channels(&self) -> Result<Channels> {
        self.encoder_ctl_request(ffi::OPUS_GET_FORCE_CHANNELS_REQUEST as i32)
            .and_then(Channels::try_from)
    }

    /// Gets the encoder's configured maximum allowed bandpass.
    pub fn max_bandwidth(&self) -> Result<Bandwidth> {
        self.encoder_ctl_request(ffi::OPUS_GET_MAX_BANDWIDTH_REQUEST as i32)
    ...
    pub fn set_max_bandwidth(&mut self, bandwidth: Bandwidth) -> Result<()> {
        self.set_encoder_ctl_request(ffi::OPUS_SET_MAX_BANDWIDTH_REQUEST as i32, bandwidth as i32)
    }

    /// Gets the encoder's configured prediction status.
    pub fn prediction_disabled(&self) -> Result<bool> {
        self.encoder_ctl_request(ffi::OPUS_GET_PREDICTION_DISABLED_REQUEST as i32)
            .map(|n| n == 1)
    }
    ...
    pub fn set_prediction_disabled(&mut self, prediction_disabled: bool) -> Result<()> {
        ...
        self.set_encoder_ctl_request(
            ffi::OPUS_SET_PREDICTION_DISABLED_REQUEST as i32,
            prediction_disabled,
        )
        .map(|_| ())
    }
    ...
    pub fn signal(&self) -> Result<Signal> {
        self.encoder_ctl_request(ffi::OPUS_GET_SIGNAL_REQUEST as i32)
    ...
    pub fn set_signal(&mut self, signal: Signal) -> Result<()> {
        self.set_encoder_ctl_request(ffi::OPUS_SET_SIGNAL_REQUEST as i32, signal as i32)
            .map(|_| ())
    }

    /// Gets the encoder's configured bandpass.
    pub fn bandwidth(&self) -> Result<Bandwidth> {
        self.encoder_ctl_request(ffi::OPUS_GET_BANDWIDTH_REQUEST as i32)
            .and_then(Bandwidth::try_from)
    }
    ...
    pub fn set_bandwidth(&mut self, bandwidth: Bandwidth) -> Result<()> {
        self.set_encoder_ctl_request(ffi::OPUS_SET_BANDWIDTH_REQUEST as i32, bandwidth as i32)
    }

    /// Gets encoder's configured use of discontinuous transmission.
    pub fn dtx(&self) -> Result<bool> {
        self.encoder_ctl_request(ffi::OPUS_GET_DTX_REQUEST as i32)
            .map(|n| n == 1)
    }
    ...
    pub fn set_dtx(&mut self, dtx: bool) -> Result<()> {
        ...
        self.set_encoder_ctl_request(ffi::OPUS_SET_DTX_REQUEST as i32, dtx_shall_be_enabled)
            .map(|_| ())
    }
    ...
    pub fn lsb_depth(&self) -> Result<u8> {
        self.encoder_ctl_request(ffi::OPUS_GET_LSB_DEPTH_REQUEST as i32)
            .map(|n| n as u8)
    }
    ...
    pub fn set_lsb_depth(&mut self, lsb_depth: u8) -> Result<()> {
        self.set_encoder_ctl_request(ffi::OPUS_SET_LSB_DEPTH_REQUEST as i32, i32::from(lsb_depth))
            .map(|_| ())
    }
}
